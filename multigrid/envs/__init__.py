...
from .emptyV2 import EmptyEnvV2
...
CONFIGURATIONS = {
    ...
    'MultiGrid-EmptyEnvV2-hidden-5x5-v0': (EmptyEnvV2, {'size': 5, 'goals': [(3, 3), (1, 3)], 'hidden_goals': True}),
    'MultiGrid-EmptyEnvV2-hidden-50x50-v0': (EmptyEnvV2, {'size': 50, 'goals': [(48, 48)], 'hidden_goals': True}),
    'MultiGrid-EmptyEnvV2-hidden-20x20-v0': (EmptyEnvV2, {'size': 20, 'goals': [(18, 18), (5, 5)], 'hidden_goals': True}),
